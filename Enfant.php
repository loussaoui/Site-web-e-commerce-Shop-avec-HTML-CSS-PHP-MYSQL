          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
				...
				if(isset($_POST['TrierN'])){
					$sql = " SELECT * FROM produits WHERE categorie='Enfant' ORDER BY nom  ";						}
				if(isset($_POST['TrierP'])){
				$sql = " SELECT * FROM produits WHERE categorie='Enfant' ORDER BY prix  ";  				}
				
			
				
				else {$sql = "SELECT * FROM produits WHERE categorie='Enfant'  "; }
